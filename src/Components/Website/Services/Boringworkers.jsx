...
export const Boringworkers = () => {
  ...
  return (
    ...
    <Container>
      <Row>
        <Col>
          <h1 className="service_all_main_headings">Boring Worker's</h1>
        </Col>
        <Col>
              <div className='service_all_see_div'>
              <Link to="/all-boring" className='service_all_see'>see all</Link>
              </div>
              </Col>
      </Row>
