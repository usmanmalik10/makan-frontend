...
export const Electricengineer = () => {
  ...
  return (
    ...
    <Container>
      <Row>
        <Col>
          <h1 className="service_all_main_headings"> Electric Engineer</h1>
        </Col>
        <Col>
              <div className='service_all_see_div'>
              <Link to="/all-electricengineer" className='service_all_see'>see all</Link>
              </div>
              </Col>
      </Row>
