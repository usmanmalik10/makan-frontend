...
export const Leithmachineoperator = () => {
  ...
  return (
    ...
    <Container>
      <Row>
        <Col>
          <h1 className="service_all_main_headings">Leith Machine Operator</h1>
        </Col>
        <Col>
              <div className='service_all_see_div'>
              <Link to="/all-leithmachine" className='service_all_see'>see all</Link>
              </div>
              </Col>
      </Row>
