...
export const Landscapearchitect = () => {
        ...
        const response = await axios.get(
          `${USERS_BASE_URL}/v1/service`,
          {
            params: {
              ...
              category: "landscapearchitecture",
            },
            headers: {
  ...
  return (
    ...
    <Container>
      <Row>
        <Col>
          <h1 className="service_all_main_headings">Landscape Architecture</h1>
        </Col>
        <Col>
              <div className='service_all_see_div'>
              <Link to="/all-landscapearchitecture" className='service_all_see'>see all</Link>
              </div>
              </Col>
      </Row>
