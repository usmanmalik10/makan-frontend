...
export const Housecleaner = () => {
  ...
  return (
    ...
    <Container>
      <Row>
        <Col>
          <h1 className="service_all_main_headings">House Cleaner</h1>
        </Col>
        <Col>
              <div className='service_all_see_div'>
              <Link to="/all-housecleaner" className='service_all_see'>see all</Link>
              </div>
              </Col>
      </Row>
