...
export const Servicepolishman = () => {
  ...
  return (
    ...
    <Container>
      <Row>
        <Col>
          <h1 className="service_all_main_headings">Polish Man (Furniture)</h1>
        </Col>
        <Col>
              <div className='service_all_see_div'>
              <Link to="/all-polishman" className='service_all_see'>see all</Link>
              </div>
              </Col>
      </Row>
