...
const RealEstateGeneralComponent = ({category  , subCategory , title}) => {
console.log({category , subCategory})
    const {
        data,
        error,
        isLoading,
      } = useGetRealEstateDataQuery({ category, subCategory , limit:6 });
  ...
  return (
    ...
    <Col>
      <div className="d-flex justify-content-between align-items-center">
        ...
        <h1 className="home_estate_all_heading">{title}</h1>
        <Link to={`/realestate/${category}/${subCategory}`}>
See All
        </Link>
      </div>
      </Col>
...
export default RealEstateGeneralComponent