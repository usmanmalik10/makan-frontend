...
export const Bricksstore = () => {
  const { data: bricksData, error: bricksError, isLoading: isBricksLoading } = useGetShopsDataQuery({
    category: 'brick',
  });
    ...
    <>
      <section> 
        <Container>
          ...
          <Row>
             {bricksData.data.docs.length === 0 && <p>No Data</p>}
            {bricksData.data.docs.map((ad) => (
