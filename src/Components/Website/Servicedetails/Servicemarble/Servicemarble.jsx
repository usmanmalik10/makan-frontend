...
export const Servicemarble = () => {
  ...
  return (
   <>
    <Header />
        <section className="service_all_pages_sec{">
            <Container>
                <Row>
                    <Col>
                        <h1 className="services_all_pages_heading">Marble & Tiles Fixers</h1>
                    </Col>
                </Row>
                <Row>
            {data.map((serviceProvider) => (
              <Col lg={4} md={4} sm={12} xs={12}>
                <Card key={serviceProvider._id} className="all_servicespage_card">
                  ...
                  <Card.Body>
                    <Card.Text>
                      ...
                      <p className="servicepage_all_data">
                        Contractor Name :{" "}
                        <span className="card_inner_text">
